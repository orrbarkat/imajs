...
import ImageFilter, { FILTER_MODE_LOCAL } from "./image_filter.js";
import pkg from 'whatsapp-web.js';
const { MessageMedia } = pkg;

const config = {
  storageMode: MODE_AWS,
  filterMode: FILTER_MODE_LOCAL,
  refrenceImages: [
...
const imageFilter = new ImageFilter(config.refrenceImages, config.filterMode);
